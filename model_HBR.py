...
class HBR_pymc(object):
    def __init__(self, data_type=None, test=False, pred=False, direct=False, logdirect=False, logN=True):
        ...
        if test:
            ...
            self.run_advi()
            # self.test_model()
            # self.load_model(model_name = 'model_1_itrace_2022-06-07 11:52:51_logn.nc')
    ...
    def test_model(self):
        print('****** loading trained model...')
        # self.load_model(model_name='model_1_itrace_2022-07-12 12:42:09_logn.nc')
        print('****** testing model...')
        with self.TT_model:
            self.Model_path_avgBtwness.set_value(self.path_avgBtwness_tst)
            self.Model_path_avgDegree.set_value(self.path_avgDegree_tst)
