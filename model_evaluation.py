...
class models_comparison(object):
    ...
    def print_error(self):
        ...
        self.mean_relative_error( self.train_df.travel_time/60., self.train_df.LRegression_tt_predMean_direct)
        self.mean_relative_error( self.train_df.travel_time/60., self.train_df.RForest_tt_predMean_direct)
        self.mean_relative_error( self.train_df.travel_time/60., self.train_df.LGBM_tt_predMean_direct)
        print("test")
        ...
        self.mean_relative_error( self.test_df.travel_time/60., self.test_df.LRegression_tt_predMean_direct)
        self.mean_relative_error( self.test_df.travel_time/60., self.test_df.RForest_tt_predMean_direct)
        self.mean_relative_error( self.test_df.travel_time/60., self.test_df.LGBM_tt_predMean_direct)
        ...
        self.mean_absolute_error( self.train_df.travel_time/60., self.train_df.LRegression_tt_predMean_direct)
        self.mean_absolute_error( self.train_df.travel_time/60., self.train_df.RForest_tt_predMean_direct)
        self.mean_absolute_error( self.train_df.travel_time/60., self.train_df.LGBM_tt_predMean_direct)
        print("test")
        ...
        self.mean_absolute_error( self.test_df.travel_time/60., self.test_df.LRegression_tt_predMean_direct)
        self.mean_absolute_error( self.test_df.travel_time/60., self.test_df.RForest_tt_predMean_direct)
        self.mean_absolute_error( self.test_df.travel_time/60., self.test_df.LGBM_tt_predMean_direct)
        ...
        self.median_relative_error( self.train_df.travel_time/60., self.train_df.LRegression_tt_predMean_direct)
        self.median_relative_error( self.train_df.travel_time/60., self.train_df.RForest_tt_predMean_direct)
        self.median_relative_error( self.train_df.travel_time/60., self.train_df.LGBM_tt_predMean_direct)
        print("test")
        ...
        self.median_relative_error( self.test_df.travel_time/60., self.test_df.LRegression_tt_predMean_direct)
        self.median_relative_error( self.test_df.travel_time/60., self.test_df.RForest_tt_predMean_direct)
        self.median_relative_error( self.test_df.travel_time/60., self.test_df.LGBM_tt_predMean_direct)
        ...
        self.median_absolute_error( self.train_df.travel_time/60., self.train_df.LRegression_tt_predMean_direct)
        self.median_absolute_error( self.train_df.travel_time/60., self.train_df.RForest_tt_predMean_direct)
        self.median_absolute_error( self.train_df.travel_time/60., self.train_df.LGBM_tt_predMean_direct)
        print("test")
        ...
        self.median_absolute_error( self.test_df.travel_time/60., self.test_df.LRegression_tt_predMean_direct)
        self.median_absolute_error( self.test_df.travel_time/60., self.test_df.RForest_tt_predMean_direct)
        self.median_absolute_error( self.test_df.travel_time/60., self.test_df.LGBM_tt_predMean_direct)
        ...
        self.root_mean_sqr_error( self.train_df.travel_time/60., self.train_df.LRegression_tt_predMean_direct)
        self.root_mean_sqr_error( self.train_df.travel_time/60., self.train_df.RForest_tt_predMean_direct)
        self.root_mean_sqr_error( self.train_df.travel_time/60., self.train_df.LGBM_tt_predMean_direct)
        print("test")
        ...
        self.root_mean_sqr_error( self.test_df.travel_time/60., self.test_df.LRegression_tt_predMean_direct)
        self.root_mean_sqr_error( self.test_df.travel_time/60., self.test_df.RForest_tt_predMean_direct)
        self.root_mean_sqr_error( self.test_df.travel_time/60., self.test_df.LGBM_tt_predMean_direct)
